...
outfile = open('models/dsb2018_96_UNet_woDS/trainloss.txt', 'w')
...
def main():
    ...
    train_img_paths = train_val_img_paths[valdatasize + int(traindatasize * 0.9):len(train_val_img_paths)]
    train_mask_paths= train_val_mask_paths[valdatasize + int(traindatasize * 0.9):len(train_val_img_paths)]
